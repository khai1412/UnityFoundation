namespace GameFoundation.Scripts.Utilities.Extension
{
    ...
    public static class ReflectionUtils
    {
        ...
        /// </summary>
        public static IEnumerable<Type> GetAllDerivedTypes<T>(bool sameAssembly = false, bool isClass = true, bool notAbstract = true)
        {
            ...
            return AppDomain.CurrentDomain.GetAssemblies()
                            ...
                            .Where(type => (!isClass || type.IsClass) && (!notAbstract || !type.IsAbstract) && baseType.IsAssignableFrom(type));
        }
